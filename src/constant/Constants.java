...
public class Constants {
    ...
    public static final int CLIENT_ID = 9880; // just for testing, in docker, need to compute with hash on ip
    public static final String HEAD_NAME = "node1";
    public static final int HEAD_ID = 9881;
    ...
    public static final long STABLIZATION_INTERVAL = 3000L;
